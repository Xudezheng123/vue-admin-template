<template>
    <div class="app-container">
        <div class="filter-container" style="margin-bottom:20px">
            ...
            <el-select v-model="pagination.deptId" clearable multiple placeholder="请选择部门" style="width:200px">
              <el-option
              v-for="item in dept"
              :key="item.code"
              :label="item.name"
        ...
        <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-tag  :key="perm.id" v-for="perm in scope.row.premissions">{{ perm.name }}</el-tag>
              </template>
            </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                ...
                <el-form-item label="角色权限码" prop="permissions">
                  <el-select v-model="form.permissions" clearable multiple placeholder="请选择权限ID" style="width:500px">
                    <el-option
    ...
    methods:{
        getList(){
            getRoleList(this.pagination).then(res=>{
              ...
              this.list = res.data.reduce((pre,cur,index,array)=>{
                cur.permissions = cur.permissions.name;
                pre.push(cur);
                return pre;
              },[]);
              console.log(res);
