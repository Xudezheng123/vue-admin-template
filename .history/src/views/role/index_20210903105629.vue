<template>
    <div class="app-container">
        <div class="filter-container" style="margin-bottom:20px">
            <el-input prefix-icon="el-icon-search" v-model="pagination.permission" placeholder="请输入角色名称查询" style="width:200px;" class="filter-item" clearable @keyup.enter.native="handleFilter"></el-input>
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="角色权限码" prop="permission">
