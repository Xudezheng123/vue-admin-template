        ...
        <el-table v-loading="loading"
          ...
          <el-table-column label="操作"
            ...
            <template v-slot="scope">
              ...
              <el-button v-if="canEditTaskDetail"
                type="primary"
                size="mini"
                title="编辑图文详情"
...
import { mapMixin } from '@/plugin/mixins/map'
import { permissionMixin } from '@/plugin/mixins/permission'
...
export default {
  ...
  mixins: [paginationMixin, mapMixin, permissionMixin],
  data() {
    return {
      form: {
        type: null,
