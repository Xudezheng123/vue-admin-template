    ...
    <div class="app-container">
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="用户账号" prop="desc">
                    <el-input v-model="form.account"></el-input>
                </el-form-item>
                <el-form-item label="手机号" prop="desc">
                    <el-input v-model="form.phone"></el-input>
                </el-form-item>
                <el-form-item label="部门ID" prop="desc">
                    <el-input v-model="form.deptId"></el-input>
                </el-form-item>
                <el-select v-model="form.deptId" clearable multiple placeholder="请选择部门" style="width:200px;margin-left: 10px;" @keyup.enter.native="handleFilter">
                    <el-option
                    v-for="item in dept"
                    :key="item.id"
                    :label="item.name"
...
,resetPassword,bindRole,getRoleList,getAllDepartmentList} from '@/api/table'
export default {
    name:'permission',
    components:{},
    data() {
