<template>
    <div class="app-container">
        <div class="filter-container" style="margin-bottom:20px">
            ...
            <el-select v-model="pagination.deptId" clearable multiple placeholder="请选择部门" style="width:200px;margin-left: 10px;" @keyup.enter.native="handleFilter">
              <el-option
              v-for="item in dept"
              :key="item.id"
              :label="item.name"
...
<script>
/* eslint-disable */
import {getManagerList,addManager,editManager,deleteManager,resetPassword,bindRole,getRoleList,getAllDepartmentList} from '@/api/table'
export default {
    name:'permission',
    components:{},
    data() {
