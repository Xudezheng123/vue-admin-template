  ...
  methods: {
    ...
    handleDrop(draggingNode, dropNode, dropType, ev) {
      ...
      // if(dropType == "before"||dropType == "after"){
        let pId = dropNode.parent.id;
        let listId = dropNode.parent.childNodes;
        let arr = listId.reduce((pre,cur,index,array)=>{
      ...
      // }else{
      //   let pId = dropNode;
      //   let listId = dropNode.data.children;
        // .reduce((prev,cur,index,array)=>{
        //   console.log("cur:",cur);
        //   console.log("prev",prev);
        //   prev.push(cur.data.id);
        // },[]).join(',')
      // }
      console.log("res:",dragId,pId,arr);
    },
    onSubmit() {
