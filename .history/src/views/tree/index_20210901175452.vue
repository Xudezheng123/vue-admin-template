...
<script>
/* eslint-disable */
import {getAllMenu ,deleteMenus ,getMenuDetail ,addMenu, moveMenu} from '@/api/table'
...
export default {
  ...
  methods: {
    ...
    handleDrop(draggingNode, dropNode, dropType, ev) {
      ...
      console.log("draggingNode.children:",draggingNode.getChildren())
      console.log("dropNode.children:",dropNode.getChildren())
      // if(dropType == "before"||dropType == "after"){
      //   pId = dropNode.parent.id;
