...
export function getArticleMessage(params) {
  return request({
    url: request.otherUrl('/article/query'),
    method: 'get',
    params
  })
}
...
export function articleListSelector(params) {
  return request({
    url: request.otherUrl('/article/select'),
    method: 'get',
    params
  })
}
export function saveArticleMessage(data) {
  ...
  // }
  return request({
    url: request.otherUrl('/article/add'),
    method: 'post',
...
export function deleteArticleMessage(data) {
  return request({
	url:request.otherUrl('/article/publish/del'),
...
export function articleSave(data) {
  ...
  return request({
    url: request.otherUrl('/article/addOrUpdate'),
    method: 'post',
    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    data: formData
  })
...
export function articleDetail(params) {
  return request({
    url: request.otherUrl('/article/get'),
    method: 'get',
    params
  })
}
...
export function pullSuCai(params) {
  return request({
    url: request.otherUrl('/article/gzh/article/pull'),
    method: 'get',
    params
  })
}
